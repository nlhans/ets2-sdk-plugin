...
.dll and c# object is complet new and won't work with old code, but i think when it is ready it would be worth to update and change odl with the new parts
