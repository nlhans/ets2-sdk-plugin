...
typedef struct scsTelemetryMap_s
{
	...
	//char buffer_ui[0]; // no more buffer here
...
struct{
	...
	char buffer_ll[152];
	//----- END OF 10TH ZONE AT OFFSET 5199 -----//
	...
	//----- END OF 11TH ZONE AT OFFSET 5399 -----//

	//----- START OF 13TH ZONE AT OFFSET 5400 -----//
	...
	//----- END OF 13TH ZONE AT OFFSET 6999 -----//
} scsTelemetryMap_t;
